...
namespace ConsoleApp1.Parser
{
    public class KeyParser
    {
        ...
        {
            List<Declaraciones> toReturn = new List<Declaraciones>();
            int initial = errors.Count;

            while (index < tokens.Length - 1)
            {

                Declaraciones Aux = ParseStatement(errors);
        ...
        #region Statement
        public Declaraciones ParseStatement(List<CompilingError> errors)
        {
            int initial = errors.Count;
            Declaraciones ToReturn = null;
